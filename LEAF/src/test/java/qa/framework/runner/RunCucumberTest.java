...
@CucumberOptions(
		...
		features = {"src/test/resources/OneCS/features" },
		glue = { 
				"qa/framework/runner",
				...
				"qa/indusmobile/device/stepdefs",
				"qa/hasura/webui/stepdefs",
		...
		//tags = { "@td_PTS_API_Pet or @Amazon-Smoke or @NotePad"}
		//tags = { "@AndroidDemo"}
		//tags = { "@Amazon-Smoke"}
		//tags = { "@td_PTS_API_Pet"}
		//tags = { "@NotePad"}
		
		tags= {"@Assign2,@Assign2"}

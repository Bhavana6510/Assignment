...
public class Reporter {
	...
	public synchronized static void addDesktopScreenshot(String message, String color) {

		String screenshotName = CaptureScreenshot.desktopScreenCapture(null);
		
		if(message==null && color ==null) {
			message="Click on image to see Screenshot !!";
			color="#1E90FF";
	...
	public synchronized static void addDeviceScreenshot(String message, String color) {

		String screenshotName = CaptureScreenshot.deviceScreenCapture(null);
	 ...
	 * 
	 * @author 10650956
	 * @param contentm : String (request or response)
	 * @param type     : String (json, xml, txt, yml)
	 */
	public synchronized static void addFile(String content, String type, String message) {

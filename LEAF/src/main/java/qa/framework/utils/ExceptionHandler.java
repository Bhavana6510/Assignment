...
/**
 * 
 * @author BathriYO NOTE: do not use cucumber-extent report reporter class here
 *         as using the same for TestNG legacy application
 *
 */
public class ExceptionHandler {
	...
	public synchronized static void handleException(Object exceptionObj) {
		...
		/*json exception*/
	else if(exceptionObj instanceof ParseException) {
		Assert.fail(CalendarUtils.getTimeStamp("MM/dd/yyyy HH:mm:ss")
				+ "!!! Exception occured while parsing the json !!! For more detail check debug log."
				+ exceptionObj.getClass().getSimpleName());
	}
		/*Socket Exception handled below*/
